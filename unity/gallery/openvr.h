...
#pragma pack(pop)
    ...
    void serialize(Archive & archive, Compositor_FrameTiming& time)
    {
        archive(
            ...
            cereal::make_nvp("NumMisPresented", time.m_nNumMisPresented),
            cereal::make_nvp("NumDroppedFrames", time.m_nNumDroppedFrames),
            time.m_nReprojectionFlags,
            cereal::make_nvp("SystemTimeInSeconds", time.m_flSystemTimeInSeconds),
            ...
            time.m_flCompositorIdleCpuMs,
            time.m_flClientFrameIntervalMs,
            time.m_flPresentCallCpuMs,
            time.m_flWaitForPresentCpuMs,
            ...
            cereal::make_nvp("NewFrameReadyMs", time.m_flNewFrameReadyMs),
    ...
    void serialize(Archive & archive, Compositor_CumulativeStats& stats)
    {
        archive(
            ...
            cereal::make_nvp("NumReprojectedFrames", stats.m_nNumReprojectedFrames),
            ...
            cereal::make_nvp("NumReprojectedFramesOnStartup", stats.m_nNumReprojectedFramesOnStartup),
            ...
            cereal::make_nvp("NumReprojectedFramesLoading", stats.m_nNumReprojectedFramesLoading),
            ...
            cereal::make_nvp("NumReprojectedFramesTimedOut", stats.m_nNumReprojectedFramesTimedOut)
        );
    }
}